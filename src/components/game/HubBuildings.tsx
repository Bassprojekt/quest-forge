...
{/* ==================== NEUE GEBÄUDE & NPCs ==================== */}
      ...
      {/* Shop ground markers - colored zones */}
      <group rotation={[-Math.PI / 2, 0, 0]} position={[-20, 0.05, 24]}>
        <mesh rotation={[0, 0, 0]}>
          <circleGeometry args={[2.5, 16]} />
          <meshStandardMaterial color="#8B4513" roughness={0.9} />
        </mesh>
        <mesh>
          <ringGeometry args={[1.5, 2.3, 16]} />
          <meshStandardMaterial color="#FFD700" emissive="#FFD700" emissiveIntensity={0.3} />
        </mesh>
      </group>
      
      <group rotation={[-Math.PI / 2, 0, 0]} position={[20, 0.05, -16]}>
        <mesh>
          <circleGeometry args={[2.5, 16]} />
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} position={[-30, 0.05, 8]}>
        <mesh>
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} position={[-15, 0.05, 20]}>
        <mesh>
          <circleGeometry args={[2, 12]} />
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.05, 34]}>
        <mesh>
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} position={[30, 0.05, -6]}>
        <mesh>
          <circleGeometry args={[2, 12]} />
          <meshStandardMaterial color="#4A3728" roughness={0.9} />
        </mesh>
