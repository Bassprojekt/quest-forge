...
const INITIAL_QUESTS: Quest[] = [
  ...
  // Neue Quests für neue Mobs
  { id: 'q36', title: 'Ameisenplage', description: 'Töte 5 Waldameisen.', type: 'kill', target: 'Waldameise', required: 5, current: 0, rewardXp: 100, rewardGold: 50, status: 'available', npcName: 'Händler Mika' },
  { id: 'q37', title: 'Käferjagd', description: 'Töte 3 Käfer.', type: 'kill', target: 'Käfer', required: 3, current: 0, rewardXp: 80, rewardGold: 40, status: 'available', npcName: 'Händler Mika' },
  { id: 'q38', title: 'Pilzwespe', description: 'Besiege die Pilzwespe.', type: 'kill', target: 'Pilzwespe', required: 1, current: 0, rewardXp: 250, rewardGold: 125, status: 'available', npcName: 'Apothekerin Flora' },
  { id: 'q39', title: 'Farnfuchs', description: 'Besiege den Farnfox.', type: 'kill', target: 'Farnfox', required: 1, current: 0, rewardXp: 280, rewardGold: 140, status: 'available', npcName: 'Apothekerin Flora' },
  { id: 'q40', title: 'Schneejäger', description: 'Töte 3 Schneejäger.', type: 'kill', target: 'Schneejäger', required: 3, current: 0, rewardXp: 400, rewardGold: 200, status: 'available', npcName: 'Schmied Vulkan' },
  { id: 'q41', title: 'Frostgeist', description: 'Besiege den Frostgeist.', type: 'kill', target: 'Frostgeist', required: 1, current: 0, rewardXp: 450, rewardGold: 225, status: 'available', npcName: 'Schmied Vulkan' },
  { id: 'q42', title: 'Feuerkäfer', description: 'Töte 3 Feuerkäfer.', type: 'kill', target: 'Feuerkäfer', required: 3, current: 0, rewardXp: 350, rewardGold: 175, status: 'available', npcName: 'Schmied Vulkan' },
  { id: 'q43', title: 'Glühwürmchen', description: 'Töte 5 Glühwürmer.', type: 'kill', target: 'Glühwurm', required: 5, current: 0, rewardXp: 450, rewardGold: 225, status: 'available', npcName: 'Schmied Vulkan' },
  { id: 'q44', title: 'Meeressammler', description: 'Sammle 10 Seeigel.', type: 'collect', target: 'Seeigel', targetItem: 'Seeigel', required: 10, current: 0, rewardXp: 300, rewardGold: 150, status: 'available', npcName: 'Händler Hans' },
  { id: 'q45', title: 'Seepferdchen', description: 'Töte 5 Seepferdchen.', type: 'kill', target: 'Seepferdchen', required: 5, current: 0, rewardXp: 350, rewardGold: 175, status: 'available', npcName: 'Händler Hans' },
  { id: 'q46', title: 'Moosgeist', description: 'Besiege den Moosgeist.', type: 'kill', target: 'Moosgeist', required: 1, current: 0, rewardXp: 500, rewardGold: 250, status: 'available', npcName: 'Apothekerin Flora' },
  { id: 'q47', title: 'Glühfee', description: 'Besiege die Glühfee.', type: 'kill', target: 'Glühfee', required: 1, current: 0, rewardXp: 600, rewardGold: 300, status: 'available', npcName: 'Waffenhändler Erik' },
  { id: 'q48', title: 'Mineralkrieger', description: 'Töte 3 Mineralkrieger.', type: 'kill', target: 'Mineralkrieger', required: 3, current: 0, rewardXp: 700, rewardGold: 350, status: 'available', npcName: 'Waffenhändler Erik' },
  { id: 'q49', title: 'Schattenpriester', description: 'Besiege den Dunkelpriester.', type: 'kill', target: 'Dunkelpriester', required: 1, current: 0, rewardXp: 800, rewardGold: 400, rewardGems: 2, status: 'available', npcName: 'Schmied Vulkan' },
  { id: 'q50', title: 'Elementar-Bezwinger', description: 'Besiege den Lavaelementar.', type: 'kill', target: 'Lavaelementar', required: 1, current: 0, rewardXp: 900, rewardGold: 450, status: 'available', npcName: 'Schmied Vulkan' },
  { id: 'q51', title: 'Wald-Feind', description: 'Töte den Feenwolf.', type: 'kill', target: 'Feenwolf', required: 1, current: 0, rewardXp: 650, rewardGold: 325, status: 'available', npcName: 'Pet-Meisterin Luna' },
  { id: 'q52', title: 'Baumhirte', description: 'Besiege den Baumhirten.', type: 'kill', target: 'Baumhirte', required: 1, current: 0, rewardXp: 750, rewardGold: 375, status: 'available', npcName: 'Gildenmeisterin Gabi' },
  { id: 'q53', title: 'Windgeist', description: 'Besiege den Windgeist.', type: 'kill', target: 'Windgeist', required: 1, current: 0, rewardXp: 850, rewardGold: 425, status: 'available', npcName: 'Event-Verkünder Evi' },
  { id: 'q54', title: 'Donnerbock', description: 'Besiege den Donnerbock.', type: 'kill', target: 'Donnerbock', required: 1, current: 0, rewardXp: 950, rewardGold: 475, status: 'available', npcName: 'Event-Verkünder Evi' },
  { id: 'q55', title: 'Abgrundwächter', description: 'Besiege den Abgrundswächter.', type: 'kill', target: 'Abgrundswächter', required: 1, current: 0, rewardXp: 1500, rewardGold: 750, rewardGems: 3, status: 'available', npcName: 'Raid-Leiter Roy' },
  { id: 'q56', title: 'Leviathan', description: 'Besiege den Schatten Leviathan.', type: 'kill', target: 'Schatten Leviathan', required: 1, current: 0, rewardXp: 2000, rewardGold: 1000, rewardGems: 5, status: 'available', npcName: 'Raid-Leiter Roy' },
  { id: 'q57', title: 'Himmelswächter', description: 'Besiege den Himmelswächter.', type: 'kill', target: 'Himmelswächter', required: 1, current: 0, rewardXp: 1800, rewardGold: 900, rewardGems: 4, status: 'available', npcName: 'Event-Verkünder Evi' },
